...
class CustomResNet18(nn.Module):
    def __init__(self, num_classes=4, pretrained=True):
        ...
        self.resnet18 = timm.create_model('resnet18', pretrained=pretrained, in_chans=1, num_classes=num_classes)
...
def main():
#     model = CustomResNet18(num_classes=4, pretrained=True)
...
#     print(f'Total trainable parameters: {total_params}')
    ...
    net.save_params(f_params="./models/model_resnet18_{}.pkl".format(wavelet))
