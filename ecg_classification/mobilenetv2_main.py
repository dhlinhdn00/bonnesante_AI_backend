...
class CustomMobileNetV2(nn.Module):
    def __init__(self, num_classes=4, pretrained=True):
        ...
        self.mobilenetv2 = timm.create_model('mobilenetv2_100', pretrained=pretrained, in_chans=1, num_classes=num_classes)
...
def main():
    model = CustomMobileNetV2(num_classes=4, pretrained=True)
    ...
    # log_dir = "./logs_resnet18/{}".format(wavelet)
    ...
    # net.save_params(f_params="./models/model_mobilenetv2_{}.pkl".format(wavelet))
